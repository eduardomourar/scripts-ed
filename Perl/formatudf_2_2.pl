...
#   Teste running on Perl version 5.10.1 and 5.16.1
#   Tested formatting on Ubuntu 11.10 and Mac OSX 10.6/10.8
#	Tested opening drive on Windows Vista/7, Ubuntu 11.10 and Mac OSX 10.6/10.8
